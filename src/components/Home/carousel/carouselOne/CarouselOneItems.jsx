...
const CarouselOneItems = ({item}) => {
  ...
  return (
    ...
    }} className=" flex flex-col rounded-lg items-center pt-1 3xs:w-14 2xs:w-16 xs:w-32 sm:w-40 w-60">
      <img className="object-contain 3xs:h-24 2x:h-28 xs:h-32 sm:h-32 h-36 mb-3" src={item.image} alt="logo" />
